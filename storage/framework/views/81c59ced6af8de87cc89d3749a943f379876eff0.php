    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('profile.edit')); ?>">
                        <i class="ni ni-single-02 text-yellow"></i> <?php echo e(__('User profile')); ?>

                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('user.index')); ?>">
                        <i class="ni ni-bullet-list-67 text-red"></i> <?php echo e(__('User Management')); ?>
            ...
            <ul class="navbar-nav mb-md-3">
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <i class="ni ni-spaceship"></i> คู่มือเริ่มต้นการใช้งาน
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <i class="ni ni-palette"></i> รู้จักกับนักพัฒนา
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(url('policy')); ?>">
                        <i class="ni ni-ui-04"></i> ข้อกำหนดการใช้งาน
                    </a>
                </li>
            </ul>
        </div>
